...
import angularJsQuiz from './angular-js'
import expressJsQuiz from './express-js'
import nextJsQuiz from './next-js'
import reactJsQuiz from './react-js'
import vueJsQuiz from './vue-js'

const frameWorksQuizzes = [
  {
    slug: 'next-js',
    title: 'Next Js',
    description:
