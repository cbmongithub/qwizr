...
const languagesQwizzes = [
  {
    slug: '/qwizzes/languages/next-js',
    title: 'Next Js',
    description:
  ...
  {
    slug: '/qwizzes/languages/react-js',
    title: 'React JS',
    description:
  ...
  {
    slug: '/qwizzes/languages/angular-js',
    title: 'Angular JS',
    description:
  ...
  {
    slug: '/qwizzes/languages/express-js',
    title: 'Express JS',
    description:
