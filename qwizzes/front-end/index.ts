...
const frontEndQwizzes = [
  {
    slug: '/qwizzes/front-end/next-js',
    title: 'Next Js',
    description:
  ...
  {
    slug: '/qwizzes/front-end/react-js',
    title: 'React JS',
    description:
  ...
  {
    slug: '/qwizzes/front-end/angular-js',
    title: 'Angular JS',
    description:
  ...
  {
    slug: '/qwizzes/front-end/express-js',
    title: 'Express JS',
    description:
