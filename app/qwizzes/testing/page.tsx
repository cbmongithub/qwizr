...
const testingQwizzes = [
  {
    slug: '/qwizzes/testing/next-js',
    title: 'Next Js',
    description:
  ...
  {
    slug: '/qwizzes/testing/angular-js',
    title: 'Angular JS',
    description:
  ...
  {
    slug: '/qwizzes/testing/express-js',
    title: 'Express JS',
    description:
...
export default function TestingPage() {
  return <Qwizzes qwizzes={testingQwizzes} />
}
